...
struct NavigationMachine_ : public boost::msm::front::state_machine_def<NavigationMachine_> {
    ...
    struct transition_table
        : boost::mpl::vector<boost::msm::front::Row<Init, boost::msm::front::none, PrepareEnterNav, SendNavRequest,
                                                    boost::msm::front::none>,
                             boost::msm::front::Row<PrepareEnterNav, NavigationTaskResponse, Done,
                                                    boost::msm::front::none, boost::msm::front::none>,
                             boost::msm::front::Row<PrepareEnterNav, CancelTaskResponse, Done, boost::msm::front::none,
                                                    CheckCancelTaskResponseSuccess>,
                             boost::msm::front::Row<PrepareEnterNav, QueryStatusResponse, Done, boost::msm::front::none,
                                                    CheckStatusQueryResponseCompleted>,
                             boost::msm::front::Row<PrepareEnterNav, QueryStatusResponse, Nav, boost::msm::front::none,
                                                    CheckStatusQueryResponseExecuting>,
                             boost::msm::front::Row<Nav, CancelTaskResponse, Done, boost::msm::front::none,
                                                    CheckCancelTaskResponseSuccess>,
                             boost::msm::front::Row<Nav, NavigationTaskResponse, Done, boost::msm::front::none,
                                                    boost::msm::front::none>,
                             boost::msm::front::Row<Nav, QueryStatusResponse, Nav, SendGetRealTimeStatusRequest,
                                                    CheckStatusQueryResponseExecuting>,
                             boost::msm::front::Row<Nav, QueryStatusResponse, Done, boost::msm::front::none,
                                                    CheckStatusQueryResponseCompleted>> {};
