...
struct BaseState : public boost::msm::front::state<> {
    ...
    void on_entry(Event const&, FSM&) {
        spdlog::info("[{}]: [NavFsm:State]: 进入{}状态", common::getCurrentTimestamp(), static_cast<Derived*>(this)->get_state_name());
    ...
    void on_exit(Event const&, FSM&) {
        spdlog::info("[{}]: [NavFsm:State]: 退出{}状态", common::getCurrentTimestamp(), static_cast<Derived*>(this)->get_state_name());
